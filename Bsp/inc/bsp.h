...
#if tx_thread_rtos == 1
static UINT _tx_posture;

#define DISABLE_INT()    _tx_posture = tx_interrupt_control(TX_INT_DISABLE)
#define ENABLE_INT()     tx_interrupt_control(_tx_posture)
#else
	/* ����ȫ���жϵĺ� */
